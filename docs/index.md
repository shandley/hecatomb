...
The seqtable (`seqtable.fasta`) is the primary output of the read preprocessing and serves as the input for Taxonomic assignment.
...
The bigtable header looks like this:
...
The purpose of this file is to expidite statistical interrogation of your data.
...
The taxonLevelCounts file looks something like this:
...
The contigSeqTable header looks like this:
...
The sankey diagram shows the sorting of reads through the preprocessing and read-based taxonomic assignment steps.
It serves to visualise the read filtering and distribution of taxonomic assignment methods.
