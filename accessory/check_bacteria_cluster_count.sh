...
# extract probably viral sequences
grep 'Viruses' $OUT/results_bacterial_check/taxonomyResult.tsv > $OUT/results_bacterial_check/viruses_table.tsv;
cut -f1 $OUT/results_bacterial_check/viruses_table.tsv > $OUT/results_bacterial_check/viruses_seqs.list;
pullseq -i $OUT/results_bacterial_check/seqtable.fasta -n $OUT/results_bacterial_check/viruses_seqs.list -l 5000 > $OUT/results_bacterial_check/viruses_seqs.fasta;
